...
// ตั้งใจไม่ดึงค่าเก่าจาก DB มาต่อท้าย ไม่งั้นรายการจะรกด้วยชื่อที่พิมพ์ไว้นานแล้ว
// (ข้อมูลเดิมของนักศึกษาไม่หาย — ค่าที่ไม่อยู่ในรายการจะเด้งไปโชว์ในช่อง "อื่นๆ" ให้เอง)
...
// เสาร์-อาทิตย์ = วันหยุด ไม่นับเป็น "ไม่ลงเวลา"
// ต่อ "T00:00:00" บังคับให้ parse เป็นเวลาท้องถิ่น — ถ้าไม่ใส่ JS อ่านเป็น UTC เที่ยงคืน แล้ววันเพี้ยนได้
// ponytail: เสาร์-อาทิตย์เท่านั้น ยังไม่รู้จักวันหยุดนักขัตฤกษ์ — ถ้าต้องการค่อยเพิ่มตาราง Holiday
